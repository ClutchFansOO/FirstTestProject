...
namespace ConsoleAPI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //3.球队对战赛赛程查询
            string url3 = "http://op.juhe.cn/onebox/football/combat";
            ...
            parameters3.Add("hteam", ""); //主队球队名称
            parameters3.Add("vteam", ""); //客队球队名称
